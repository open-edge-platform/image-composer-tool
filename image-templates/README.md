...
| a robotics stack, built from scratch | `ubuntu24-x86_64-robotics-jazzy-raw.yml` |
...
24 of the 63 templates are built by a `scripts/build_*.sh` script on every pull
