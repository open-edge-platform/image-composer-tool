...
This decides which parent you pick. `ubuntu24-x86_64-robotics-jazzy-extends-raw.yml`
inherits the *minimal* image and therefore also installs six GRUB packages it
never uses, because it boots with systemd-boot. That is a real cost, accepted
