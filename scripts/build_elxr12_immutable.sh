...
build_elxr12_immutable_raw_image() {
  echo "Building ELXR12 immutable raw Image. (using earthly built binary)"
  ...
  set +e
  output=$( sudo -S ./build/image-composer-tool build image-templates/elxr12/elxr12-x86_64-edge-raw.yml 2>&1)
  build_exit_code=$?
  set -e
