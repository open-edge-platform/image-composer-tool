...
Users of ICT often need to understand or validate images they have
...
Users may want to:
- Inspect an image generated by ICT
- Compare multiple images generated by the same pipeline
- Compare an image created by ICT against one created elsewhere
